...
env.read_env(BASE_DIR / f"{DEPLOYMENT_ENVIRONMENT}.env")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "MetroCityDevelopers API",
    "DESCRIPTION": "Documentation of API endpoints of MetroCityDevelopers",
    "VERSION": "1.0.0",
